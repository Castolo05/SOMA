...
function FirstVisitTutorial() {
  ...
  return (
    <div className="fixed inset-0 z-[100] flex items-center justify-center bg-slate-900/65 p-4 backdrop-blur-sm">
      <div className="w-full max-w-md overflow-hidden rounded-[30px] border border-[#c8b3b0] bg-[#f9e2da] shadow-2xl dark:border-[#b8c2c1] dark:bg-[#345f63]">
          ...
          <div className="flex gap-2">
            {step > 0 && (
              <button
                ...
                className="flex-1 rounded-2xl border border-[#c8b3b0] bg-[#f2c6b6] px-4 py-3 text-sm font-semibold text-gray-700 transition hover:bg-peach-100 dark:border-[#b8c2c1] dark:bg-[#2f5d62] dark:text-gray-200 dark:hover:bg-[#7fd1c8]"
              >
                Atrás
              </button>
            )}
